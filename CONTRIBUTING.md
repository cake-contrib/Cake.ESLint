# Contributing to Cake.ESLint

First and foremost, thank you! We appreciate that you want to contribute to Cake.ESLint,
...
**Showing support for Cake.ESLint**  
...
Don't have time to contribute? No worries, here are some other ways to show your support for Cake.ESLint:

- star the [project][]
- tweet your support for Cake.ESLint
...
- **version**: (required) please note the version of Cake.ESLint you are using
...
- **addins, etc**: (if applicable) please list any other addins you're using that may affect the Cake.ESLint addin

### Closing issues

The original poster or the maintainers of Cake.ESLint may close an issue at any time.
Typically, but not exclusively, issues are closed when:

- The issue is resolved, and will be released in the next version of Cake.ESLint
...
[project]: https://github.com/cake-contrib/Cake.ESLint
